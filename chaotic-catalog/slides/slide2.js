...
<div class="h-full flex flex-col justify-between space-y-4 md:space-y-0 text-slate-800">
    ...
    <div class="hidden lg:flex flex-col md:flex-row md:items-center md:justify-between gap-3 border-b border-purple-100 pb-3">
        <div class="flex items-center gap-3">
            <span class="px-3 py-1 bg-purple-600 text-white font-mono font-bold text-xs uppercase tracking-wider rounded-full shadow-sm">
                Nivel 1
            </span>
            <h2 class="font-display text-lg md:text-xl font-black text-purple-900 uppercase tracking-tight">
                Primitivos de UI (Headless)
            </h2>
        </div>
        <div class="flex items-center gap-1.5 text-xs font-semibold text-purple-600 bg-purple-50 border border-purple-100 px-3 py-1 rounded-full">
            <span class="w-1.5 h-1.5 bg-purple-600 rounded-full animate-ping"></span>
            Control Total
        </div>
    </div>
